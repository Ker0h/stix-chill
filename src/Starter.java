...
public class Starter {
    public static void main(String args[]) throws Exception {
        ...
        Profile jop1 = new Profile("Jop1", sdf.parse("24-11-1995"), jop);
        Profile stijnRestricted = new Profile("Stijn Restricted", sdf.parse("13-01-2002"), stijn);
        Profile ywillems = new Profile("ywillems", sdf.parse("29-09-1996"), yannick);
